...
Function Deploy-GuardrailsSolutionAccelerator {
    ...
    .DESCRIPTION
        ...
        and resource naming conventions. See this page for details: https://github.com/ssc-spc-ccoe-cei/workshop-test-azure-cac/blob/main/docs/setup.md.
    ...
    .LINK
        https://github.com/ssc-spc-ccoe-cei/workshop-test-azure-cac
    .EXAMPLE 
    ...
    Else {
        ...
        ElseIf ([string]::IsNullOrEmpty($releaseVersion) -and !$prerelease.IsPresent) {
            ...
            $moduleBaseURL = "https://github.com/ssc-spc-ccoe-cei/workshop-test-azure-cac/raw/{0}/psmodules" -f $latestRelease.name
        ...
        ElseIf ($releaseVersion) {
            ...
            $releases = Invoke-RestMethod 'https://api.github.com/repos/ssc-spc-ccoe-cei/workshop-test-azure-cac/releases' -Verbose:$false
            
            If ($releases.name -contains $releaseVersion) {
                Write-Verbose "Found a release on GitHub match for $releaseVersion"
                $moduleBaseURL = "https://github.com/ssc-spc-ccoe-cei/workshop-test-azure-cac/releases/download/{0}/" -f $releaseVersion
            }
        }
        # ElseIf ($prerelease) {
        ...
        If (-NOT($alternatePSModulesURL)) {
            ...
            try {
                ...
                Write-Error "The release $releaseVersion does not contain the 'GR-Common.zip' file as an asset. This likely means the release was not properly published, or was published using an older process and is not recommended for new deployments. See: https://github.com/ssc-spc-ccoe-cei/workshop-test-azure-cac/releases"
                return
            }
